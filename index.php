		...
		<div class="navbar m-3">
			<form action="index.php" method="POST" id="form" class="container-md">
				...
				<div class="input-group w-75 mb-3">
				  <input type="text" id="resultText" class="form-control mt-3" placeholder="Text result" aria-label="Recipient's username" name="input_text_result" aria-describedby="button-addon2" value="<?php echo returnText(); ?>">
